...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/sdks/master/_listings/google-cloud-source-repositories/apis.yaml
...
- name: Cloud Source Repositories API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/sdks/master/_listings/google-cloud-source-repositories/v1-resource-testiampermissions-post.md
x-common:
- type: x-concepts
